    ...
    if (window.SpeechRecognition || window.webkitSpeechRecognition) {
      ...
      receber_audio.onresult = function (event) {
        ...
        if (token === null||token===undefined) {
          ...
          if (textarea.value == "contato" || textarea.value == "Contato" || textarea.value == "Contatos") {
            history.push("/contato");
            window.location.reload();
          }

          if (textarea.value == "Servico" || textarea.value == "servico" || textarea.value == "servicos" || textarea.value == "serviços") {
