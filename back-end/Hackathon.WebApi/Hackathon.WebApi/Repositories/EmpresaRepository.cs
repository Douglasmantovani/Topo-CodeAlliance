        ...
        public bool AtualizarVaga(int idVaga, Vaga vaga)
        {
            using (HackathonContext ctx = new HackathonContext())
            {
                try
                {
                    ...
                    if (vaga.IdTipoRegimePresencial != 0)
                        vagaBuscada.IdTipoRegimePresencial = vaga.IdTipoRegimePresencial;
            ...
            using (HackathonContext ctx = new HackathonContext())
            {
                try
                {
                   ...
                   new Candidato
                   {
                       ...
                       Telefone = u.IdCandidatoNavigation.Telefone,IdUsuarioNavigation=
